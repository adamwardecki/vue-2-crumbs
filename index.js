...
var _breadcrumbComponent = __webpack_require__(12);
...
var vue2Crumbs = {
  ...
  install: function install(Vue, options) {
    function $_vue2Crumbs_dispatchNewValue(meta) {
      var _$breadcrumb = this.$breadcrumb,
          label = _$breadcrumb.label,
          parentsList = _$breadcrumb.parentsList,
          parent = _$breadcrumb.parent,
          utils = _$breadcrumb.utils;
      ...
      var metaBreadcrumb = meta.breadcrumb;
    ...
    function $_vue2Crumbs_checkMatchedRoutes() {
      if (this.$breadcrumb) {
        var matchedRoutes = [].concat(_toConsumableArray(this.$route.matched)).reverse();
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;

        try {
          for (var _iterator = matchedRoutes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var route = _step.value;

            var routeComponentInstance = route.instances.default;

            if ((0, _lodash2.default)(routeComponentInstance, this)) {
    ...
    Vue.component(_breadcrumbComponent2.default.name, _breadcrumbComponent2.default);
...
exports.default = {
  ...
  methods: {
    ...
    getBreadcrumb: function getBreadcrumb(route) {
      ...
      var componentBreadcrumb = void 0;
  ...
  watch: {
    '$route': function $route(newRoute) {
      ...
      this.parentsDynamicRoutes = [].concat(_toConsumableArray((0, _get2.default)(newRoute, 'meta.breadcrumb.parentsList', []))).reverse();
    }
  },
...
var memoizeCapped = __webpack_require__(22);
...
var mapCacheClear = __webpack_require__(25),
